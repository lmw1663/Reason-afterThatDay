...
F. 매듭 트랙 부활 (졸업 재설계): ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓  98%  🔄 (F-1~F-12·F-13 코드측·P1 정리 완료 14커밋, F-13 공식 A-4 해제만 외부 임상 재검증 의존)
...
| F-12-P1 | 통합 검증 P1 4건 정리 — useRevisitTrigger 안전·cancelRevisitsForCooling·cycle-prompt 위기 가드·useKnotCooldownReset (P1-D는 useCoolingStore 확장 필요해 후속) | ✅ | `f1d9954` |
